...
impl WeightInfo for () {
	...
	fn on_initialize() -> Weight {
		...
		Weight::from_parts(36_201_000, 6385)
	...
	fn token_config() -> Weight {
		...
		Weight::from_parts(42_536_000, 3574)
	...
	fn refresh_token_info() -> Weight {
		...
		Weight::from_parts(56_513_000, 3835)
			.saturating_add(RocksDbWeight::get().reads(2_u64))
	...
	fn payout() -> Weight {
		...
		//  Measured:  `706`
		//  Estimated: `4171`
		// Minimum execution time: 80_069_000 picoseconds.
		Weight::from_parts(82_441_000, 4171)
	...
	fn delete_token() -> Weight {
		...
		Weight::from_parts(28_579_000, 1654)
