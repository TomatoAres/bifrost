...
// --steps=50
// --repeat=20
// --pallet=bifrost_vstoken-conversion
// --extrinsic=*
// --execution=wasm
...
impl WeightInfo for () {
	...
	fn set_exchange_fee() -> Weight {
		...
		Weight::from_parts(21_188_000, 1517)
	...
	fn set_exchange_rate() -> Weight {
		...
		Weight::from_parts(23_228_000, 3479)
			.saturating_add(RocksDbWeight::get().reads(1_u64))
			.saturating_add(RocksDbWeight::get().writes(1_u64))
	}
	...
	fn set_relaychain_lease() -> Weight {
		...
		Weight::from_parts(20_639_000, 1489)
			.saturating_add(RocksDbWeight::get().reads(1_u64))
			.saturating_add(RocksDbWeight::get().writes(1_u64))
	}
	...
	fn vsbond_convert_to_vstoken() -> Weight {
		...
		//  Measured:  `1461`
		//  Estimated: `11362`
		// Minimum execution time: 186_527_000 picoseconds.
		Weight::from_parts(201_205_000, 11362)
	...
	fn vstoken_convert_to_vsbond() -> Weight {
		...
		//  Measured:  `1453`
		//  Estimated: `11362`
		// Minimum execution time: 181_662_000 picoseconds.
		Weight::from_parts(188_009_000, 11362)
