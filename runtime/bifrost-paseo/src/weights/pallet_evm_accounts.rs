...
// --heap-pages=4096
// --output=./runtime/bifrost-paseo/src/weights/pallet_evm_accounts.rs
...
impl<T: frame_system::Config> pallet_evm_accounts::WeightInfo for BifrostWeight<T> {
	...
	fn bind_evm_address() -> Weight {
		...
		//  Measured:  `173`
		//  Estimated: `3593`
		// Minimum execution time: 18_926 nanoseconds.
		Weight::from_parts(20_610_000, 3593)
	...
	fn add_contract_deployer() -> Weight {
		...
		//  Measured:  `27`
		//  Estimated: `1512`
		// Minimum execution time: 8_616 nanoseconds.
		Weight::from_parts(9_247_000, 1512)
	...
	fn remove_contract_deployer() -> Weight {
		...
		Weight::from_parts(9_799_000, 1512)
			.saturating_add(T::DbWeight::get().reads(4))
			.saturating_add(T::DbWeight::get().writes(3))
	}
	// Storage: `System::Number` (r:1 w:0)
	...
	fn renounce_contract_deployer() -> Weight {
		...
		Weight::from_parts(8_687_000, 1512)
			.saturating_add(T::DbWeight::get().reads(4))
			.saturating_add(T::DbWeight::get().writes(3))
	}
}
