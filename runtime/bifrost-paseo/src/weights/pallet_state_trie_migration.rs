...
impl<T: frame_system::Config> pallet_state_trie_migration::WeightInfo for BifrostWeight<T> {
	...
	fn continue_migrate() -> Weight {
		...
		Weight::from_parts(17_303_000, 3550)
	...
	fn continue_migrate_wrong_witness() -> Weight {
		...
		Weight::from_parts(2_895_000, 1493)
	...
	fn migrate_custom_top_success() -> Weight {
		...
		//  Measured:  `207`
		//  Estimated: `3550`
		// Minimum execution time: 11_492 nanoseconds.
		Weight::from_parts(12_234_000, 3550)
	...
	fn migrate_custom_top_fail() -> Weight {
		...
		Weight::from_parts(62_470_000, 3788)
			.saturating_add(T::DbWeight::get().reads(7))
	...
	fn migrate_custom_child_success() -> Weight {
		...
		Weight::from_parts(12_624_000, 3550)
			.saturating_add(T::DbWeight::get().reads(5))
			.saturating_add(T::DbWeight::get().writes(2))
	}
	// Storage: `Balances::Holds` (r:1 w:1)
	...
	fn migrate_custom_child_fail() -> Weight {
		...
		Weight::from_parts(63_892_000, 3786)
			.saturating_add(T::DbWeight::get().reads(7))
			.saturating_add(T::DbWeight::get().writes(5))
	}
	...
	fn process_top_key(v: u32, ) -> Weight {
		...
		Weight::from_parts(676_877_894, 3590)
			// Standard Error: 65
			.saturating_add(Weight::from_parts(1_528, 0).saturating_mul(v.into()))
			.saturating_add(T::DbWeight::get().reads(1))
