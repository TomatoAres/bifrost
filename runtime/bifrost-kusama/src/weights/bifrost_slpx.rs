...
impl<T: frame_system::Config> bifrost_slpx::WeightInfo for BifrostWeight<T> {
	...
	fn add_whitelist() -> Weight {
		...
		Weight::from_parts(31_446_000, 3803)
	...
	fn remove_whitelist() -> Weight {
		...
		Weight::from_parts(34_812_000, 3803)
			.saturating_add(T::DbWeight::get().reads(1))
			.saturating_add(T::DbWeight::get().writes(1))
	}
	...
	fn mint() -> Weight {
		...
		Weight::from_parts(40_436_000, 114987)
	...
	fn mint_with_channel_id() -> Weight {
		...
		//  Measured:  `81`
		//  Estimated: `114987`
		// Minimum execution time: 39_458 nanoseconds.
		Weight::from_parts(40_157_000, 114987)
			.saturating_add(T::DbWeight::get().reads(2))
			.saturating_add(T::DbWeight::get().writes(1))
	}
	// Storage: `Slpx::WhitelistAccountId` (r:1 w:0)
	...
	fn redeem() -> Weight {
		...
		//  Measured:  `81`
		//  Estimated: `114987`
		// Minimum execution time: 39_414 nanoseconds.
		Weight::from_parts(40_053_000, 114987)
			.saturating_add(T::DbWeight::get().reads(2))
			.saturating_add(T::DbWeight::get().writes(1))
	}
	// Storage: `Slpx::WhitelistAccountId` (r:1 w:0)
	...
	fn evm_create_order() -> Weight {
		...
		Weight::from_parts(39_612_000, 114987)
			.saturating_add(T::DbWeight::get().reads(2))
			.saturating_add(T::DbWeight::get().writes(1))
	}
}
