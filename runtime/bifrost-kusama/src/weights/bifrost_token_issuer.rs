...
impl<T: frame_system::Config> bifrost_token_issuer::WeightInfo for BifrostWeight<T> {
	...
	fn add_to_issue_whitelist() -> Weight {
		...
		//  Measured:  `109`
		//  Estimated: `3574`
		// Minimum execution time: 33_124 nanoseconds.
		Weight::from_parts(33_957_000, 3574)
	...
	fn remove_from_issue_whitelist() -> Weight {
		...
		Weight::from_parts(36_662_000, 3652)
			.saturating_add(T::DbWeight::get().reads(1))
			.saturating_add(T::DbWeight::get().writes(1))
	}
	...
	fn add_to_transfer_whitelist() -> Weight {
		...
		Weight::from_parts(48_534_000, 3574)
			.saturating_add(T::DbWeight::get().reads(1))
			.saturating_add(T::DbWeight::get().writes(1))
	}
	// Storage: `TokenIssuer::TransferWhiteList` (r:1 w:1)
	...
	fn remove_from_transfer_whitelist() -> Weight {
		...
		Weight::from_parts(50_797_000, 3652)
			.saturating_add(T::DbWeight::get().reads(1))
			.saturating_add(T::DbWeight::get().writes(1))
	}
	...
	fn issue() -> Weight {
		...
		//  Measured:  `680`
		//  Estimated: `4145`
		// Minimum execution time: 88_087 nanoseconds.
		Weight::from_parts(134_378_000, 4145)
	...
	fn transfer() -> Weight {
		...
		Weight::from_parts(128_853_000, 6176)
