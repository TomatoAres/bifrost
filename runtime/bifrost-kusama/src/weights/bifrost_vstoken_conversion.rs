...
impl<T: frame_system::Config> bifrost_vstoken_conversion::WeightInfo for BifrostWeight<T> {
	...
	fn set_exchange_fee() -> Weight {
		...
		Weight::from_parts(27_639_000, 1517)
	...
	fn set_exchange_rate() -> Weight {
		...
		Weight::from_parts(30_372_000, 3479)
			.saturating_add(T::DbWeight::get().reads(1))
			.saturating_add(T::DbWeight::get().writes(1))
	}
	...
	fn set_relaychain_lease() -> Weight {
		...
		Weight::from_parts(26_243_000, 1489)
			.saturating_add(T::DbWeight::get().reads(1))
			.saturating_add(T::DbWeight::get().writes(1))
	}
	...
	fn vsbond_convert_to_vstoken() -> Weight {
		...
		//  Measured:  `1495`
		//  Estimated: `11362`
		// Minimum execution time: 226_650 nanoseconds.
		Weight::from_parts(230_381_000, 11362)
	...
	fn vstoken_convert_to_vsbond() -> Weight {
		...
		//  Measured:  `1487`
		//  Estimated: `11362`
		// Minimum execution time: 219_458 nanoseconds.
		Weight::from_parts(223_798_000, 11362)
