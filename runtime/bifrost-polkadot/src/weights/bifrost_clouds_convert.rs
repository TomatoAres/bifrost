...
// --steps=50
// --repeat=20
// --pallet=bifrost_clouds_convert
// --extrinsic=*
// --execution=wasm
// --wasm-execution=compiled
// --heap-pages=4096
// --output=./runtime/bifrost-polkadot/src/weights/bifrost_clouds_convert.rs
...
/// Weight functions for bifrost_clouds_convert.
...
impl<T: frame_system::Config> bifrost_clouds_convert::WeightInfo for BifrostWeight<T> {
	...
	fn clouds_to_vebnc() -> Weight {
		...
		//  Measured:  `1730`
		//  Estimated: `8769`
		// Minimum execution time: 348_008 nanoseconds.
		Weight::from_parts(356_409_000, 8769)
	...
	fn charge_vbnc() -> Weight {
		...
		//  Measured:  `1360`
		//  Estimated: `6196`
		// Minimum execution time: 109_401 nanoseconds.
		Weight::from_parts(111_287_000, 6196)
