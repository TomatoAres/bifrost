...
impl<T: frame_system::Config> pallet_evm_accounts::WeightInfo for BifrostWeight<T> {
	...
	fn bind_evm_address() -> Weight {
		...
		//  Measured:  `470`
		//  Estimated: `3593`
		// Minimum execution time: 64_289 nanoseconds.
		Weight::from_parts(65_391_000, 3593)
	...
	fn add_contract_deployer() -> Weight {
		...
		//  Measured:  `27`
		//  Estimated: `1512`
		// Minimum execution time: 26_737 nanoseconds.
		Weight::from_parts(28_708_000, 1512)
	...
	fn remove_contract_deployer() -> Weight {
		...
		Weight::from_parts(28_631_000, 1512)
			.saturating_add(T::DbWeight::get().reads(4))
			.saturating_add(T::DbWeight::get().writes(3))
	}
	// Storage: `System::Number` (r:1 w:0)
	...
	fn renounce_contract_deployer() -> Weight {
		...
		Weight::from_parts(29_179_000, 1512)
			.saturating_add(T::DbWeight::get().reads(4))
			.saturating_add(T::DbWeight::get().writes(3))
	}
}
